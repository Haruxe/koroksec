...
function WalletsTool() {
  ...
  const [result, setResult] = useState({ address: "", balance: "" });
  ...
  function handleInput(e: any) {
    ...
    setStatusMessage({ opacity: "0", color: "", message: "." });
  }
    ...
    <div className="select-none w-full h-full m-auto font-mono flex flex-col">
      <div className="flex flex-col justify-start gap-0">
        ...
        <i className="text-xs text-zinc-400">
          Note: You should not trust a private key given by a public website for
          personal uses.
        </i>
      </div>
