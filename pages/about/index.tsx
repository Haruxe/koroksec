    ...
    <>
      <div className="max-w-[800px] min-h-[88vh] mx-auto font-mono flex p-4 flex-col">
        <div className="place-content-center flex flex-col">
          ...
          <div className="">
            <h1 className="font-bold sm:text-xl text-lg">Introduction</h1>
            ...
            <h1 className="mt-10 font-bold sm:text-xl text-lg">Our Team</h1>
            <p className="sm:text-lg text-md leading-relaxed mt-5 text-zinc-300">
              -{" "}
              <a
                href="https://twitter.com/haruxeETH"
            ...
            <h1 className="mt-10 font-bold sm:text-xl text-lg">Our Approach</h1>
            <p className="sm:text-lg text-md leading-relaxed mt-5 text-zinc-300">
            ...
            <p className="leading-relaxed mt-5 text-md sm:text-lg text-zinc-300">
